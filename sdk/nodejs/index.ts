...
export { BlackoutWindowArgs, BlackoutWindowState } from "./blackoutWindow";
export type BlackoutWindow = import("./blackoutWindow").BlackoutWindow;
export const BlackoutWindow: typeof import("./blackoutWindow").BlackoutWindow = null as any;
utilities.lazyLoad(exports, ["BlackoutWindow"], () => require("./blackoutWindow"));

export { ClientCaCertArgs, ClientCaCertState } from "./clientCaCert";
export type ClientCaCert = import("./clientCaCert").ClientCaCert;
export const ClientCaCert: typeof import("./clientCaCert").ClientCaCert = null as any;
utilities.lazyLoad(exports, ["ClientCaCert"], () => require("./clientCaCert"));
...
export { EgressPrivateEndpointArgs, EgressPrivateEndpointState } from "./egressPrivateEndpoint";
export type EgressPrivateEndpoint = import("./egressPrivateEndpoint").EgressPrivateEndpoint;
export const EgressPrivateEndpoint: typeof import("./egressPrivateEndpoint").EgressPrivateEndpoint = null as any;
utilities.lazyLoad(exports, ["EgressPrivateEndpoint"], () => require("./egressPrivateEndpoint"));

export { EgressPrivateEndpointDomainNamesArgs, EgressPrivateEndpointDomainNamesState } from "./egressPrivateEndpointDomainNames";
export type EgressPrivateEndpointDomainNames = import("./egressPrivateEndpointDomainNames").EgressPrivateEndpointDomainNames;
export const EgressPrivateEndpointDomainNames: typeof import("./egressPrivateEndpointDomainNames").EgressPrivateEndpointDomainNames = null as any;
utilities.lazyLoad(exports, ["EgressPrivateEndpointDomainNames"], () => require("./egressPrivateEndpointDomainNames"));

export { EgressRuleArgs, EgressRuleState } from "./egressRule";
export type EgressRule = import("./egressRule").EgressRule;
export const EgressRule: typeof import("./egressRule").EgressRule = null as any;
utilities.lazyLoad(exports, ["EgressRule"], () => require("./egressRule"));

export { EgressTrafficPolicyArgs, EgressTrafficPolicyState } from "./egressTrafficPolicy";
export type EgressTrafficPolicy = import("./egressTrafficPolicy").EgressTrafficPolicy;
export const EgressTrafficPolicy: typeof import("./egressTrafficPolicy").EgressTrafficPolicy = null as any;
utilities.lazyLoad(exports, ["EgressTrafficPolicy"], () => require("./egressTrafficPolicy"));
...
export { GetBlackoutWindowsArgs, GetBlackoutWindowsResult, GetBlackoutWindowsOutputArgs } from "./getBlackoutWindows";
export const getBlackoutWindows: typeof import("./getBlackoutWindows").getBlackoutWindows = null as any;
export const getBlackoutWindowsOutput: typeof import("./getBlackoutWindows").getBlackoutWindowsOutput = null as any;
utilities.lazyLoad(exports, ["getBlackoutWindows","getBlackoutWindowsOutput"], () => require("./getBlackoutWindows"));
...
export { PhysicalReplicationStreamArgs, PhysicalReplicationStreamState } from "./physicalReplicationStream";
export type PhysicalReplicationStream = import("./physicalReplicationStream").PhysicalReplicationStream;
export const PhysicalReplicationStream: typeof import("./physicalReplicationStream").PhysicalReplicationStream = null as any;
utilities.lazyLoad(exports, ["PhysicalReplicationStream"], () => require("./physicalReplicationStream"));
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "cockroach:index/blackoutWindow:BlackoutWindow":
                return new BlackoutWindow(name, <any>undefined, { urn })
            case "cockroach:index/clientCaCert:ClientCaCert":
            ...
            case "cockroach:index/egressPrivateEndpoint:EgressPrivateEndpoint":
                return new EgressPrivateEndpoint(name, <any>undefined, { urn })
            case "cockroach:index/egressPrivateEndpointDomainNames:EgressPrivateEndpointDomainNames":
                return new EgressPrivateEndpointDomainNames(name, <any>undefined, { urn })
            case "cockroach:index/egressRule:EgressRule":
                return new EgressRule(name, <any>undefined, { urn })
            case "cockroach:index/egressTrafficPolicy:EgressTrafficPolicy":
                return new EgressTrafficPolicy(name, <any>undefined, { urn })
            ...
            case "cockroach:index/physicalReplicationStream:PhysicalReplicationStream":
                return new PhysicalReplicationStream(name, <any>undefined, { urn })
            ...
            case "cockroach:index/restore:Restore":
...
pulumi.runtime.registerResourceModule("cockroach", "index/egressPrivateEndpointDomainNames", _module)
pulumi.runtime.registerResourceModule("cockroach", "index/egressRule", _module)
pulumi.runtime.registerResourceModule("cockroach", "index/egressTrafficPolicy", _module)
...
pulumi.runtime.registerResourceModule("cockroach", "index/physicalReplicationStream", _module)
...
pulumi.runtime.registerResourceModule("cockroach", "index/restore", _module)
