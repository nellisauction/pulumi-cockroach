 ...
 *     metricExportDatadogConfigId: clusterId,
 *     site: datadogSite,
...
export class MetricExportDatadogConfig extends pulumi.CustomResource {
     ...
     * Cluster ID.
     */
    declare public readonly metricExportDatadogConfigId: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: MetricExportDatadogConfigArgs | MetricExportDatadogConfigState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["metricExportDatadogConfigId"] = state?.metricExportDatadogConfigId;
            ...
            if (args?.metricExportDatadogConfigId === undefined && !opts.urn) {
                throw new Error("Missing required property 'metricExportDatadogConfigId'");
            }
            if (args?.site === undefined && !opts.urn) {
                throw new Error("Missing required property 'site'");
            }
            resourceInputs["apiKey"] = args?.apiKey ? pulumi.secret(args.apiKey) : undefined;
            resourceInputs["metricExportDatadogConfigId"] = args?.metricExportDatadogConfigId;
...
export interface MetricExportDatadogConfigState {
     ...
     * Cluster ID.
     */
    metricExportDatadogConfigId?: pulumi.Input<string | undefined>;
    /**
     * The Datadog region to export to.
     */
...
export interface MetricExportDatadogConfigArgs {
     ...
     * Cluster ID.
     */
    metricExportDatadogConfigId: pulumi.Input<string>;
    /**
     * The Datadog region to export to.
     */
