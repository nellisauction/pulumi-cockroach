 ...
 * const example = new cockroach.MetricExportPrometheusConfig("example", {metricExportPrometheusConfigId: clusterId});
 * ```
 *
 * ## Import
 *
...
export class MetricExportPrometheusConfig extends pulumi.CustomResource {
     ...
     * Cluster ID.
     */
    declare public readonly metricExportPrometheusConfigId: pulumi.Output<string>;
    /**
    ...
    /**
     * Represents prometheus scrape endpoint for each region. You can fetch endpoints either by executing `terraform state show {resource}` or by enabling terraform logs.
     */
    declare public /*out*/ readonly targets: pulumi.Output<{[key: string]: string}>;
    ...
    constructor(name: string, argsOrState?: MetricExportPrometheusConfigArgs | MetricExportPrometheusConfigState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["metricExportPrometheusConfigId"] = state?.metricExportPrometheusConfigId;
            resourceInputs["status"] = state?.status;
            resourceInputs["targets"] = state?.targets;
        } else {
            const args = argsOrState as MetricExportPrometheusConfigArgs | undefined;
            if (args?.metricExportPrometheusConfigId === undefined && !opts.urn) {
                throw new Error("Missing required property 'metricExportPrometheusConfigId'");
            }
            resourceInputs["metricExportPrometheusConfigId"] = args?.metricExportPrometheusConfigId;
...
export interface MetricExportPrometheusConfigState {
     ...
     * Cluster ID.
     */
    metricExportPrometheusConfigId?: pulumi.Input<string | undefined>;
    /**
     * The current state of the metric export configuration.  Possible values are: [`NOT_DEPLOYED` `DISABLING` `ENABLING` `ENABLED` `ERROR`]
     */
     ...
     * Represents prometheus scrape endpoint for each region. You can fetch endpoints either by executing `terraform state show {resource}` or by enabling terraform logs.
     */
    targets?: pulumi.Input<{[key: string]: pulumi.Input<string>} | undefined>;
}
...
export interface MetricExportPrometheusConfigArgs {
     ...
     * Cluster ID.
     */
    metricExportPrometheusConfigId: pulumi.Input<string>;
}
