...
export class AllowList extends pulumi.CustomResource {
     ...
     */
    declare public readonly sql: pulumi.Output<boolean>;
    /**
     * Set to 'true' to allow access to the management console from this CIDR range.
     */
    declare public readonly ui: pulumi.Output<boolean>;
    ...
    constructor(name: string, argsOrState?: AllowListArgs | AllowListState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            if (args?.cidrMask === undefined && !opts.urn) {
...
export interface AllowListState {
     ...
     * Set to 'true' to allow SQL connections from this CIDR range.
     */
    sql?: pulumi.Input<boolean | undefined>;
    /**
     * Set to 'true' to allow access to the management console from this CIDR range.
     */
    ui?: pulumi.Input<boolean | undefined>;
}
